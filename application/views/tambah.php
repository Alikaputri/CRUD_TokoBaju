				...
				<div class="card-body">
					<form action="" method="post" class="needs-validation" novalidate>
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nm_barang" id="nm_barang" placeholder="Masukan Nama Barang" autocomplete="off" required>
						...
						<div class="form-group">
							...
							<input type="ukuran" class="form-control" name="ukuran" id="ukuran" placeholder="Masukan Ukuran Barang" autocomplete="off" required>
							<div class="invalid-feedback">
						...
						<div class="form-group">
							...
							<input type="stok" class="form-control" name="stok" id="stok" placeholder="Masukan Jumlah Stok Barang" autocomplete="off" required>
							<div class="invalid-feedback">
